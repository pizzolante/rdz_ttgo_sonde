...
[ "tcp.radiosondy.active", "Invio dati a radiosondy.info"],
[ "tcp.rotate.active", "Invio dati a rotate.aprs.net"],
[ "tcp.rotate.beacon_interval", "Intervallo beacon rotate.aprs.net (minuti)"],
[ "tcp.rotate.smart_beacon", "Smart Beacon Rotate (1=solo con sonda attiva, 0=sempre)"],
...
[ "tcp.comment", "APRS location comment (generale/radiosondy)"],
[ "tcp.rotate.comment", "Commento beacon per rotate.aprs.net"],
[ "tcp.rotate.device", "Dispositivo (mostrato su aprs.fi insieme al commento)"],
...
[ "telegram.active", "Telegram active (0=disabled, 1=enabled)"],
[ "telegram.token", "Telegram Bot API Token"],
[ "telegram.chat_id", "Telegram destination Chat ID"],
[ "telegram.notify_new", "Notify new sonde detected (0=no, 1=yes)"],
[ "telegram.notify_burst", "Notify balloon burst (0=no, 1=yes)"],
[ "telegram.notify_end", "Notify flight end (0=no, 1=yes)"],
[ "telegram.end_delay", "End notification delay [seconds]"],
